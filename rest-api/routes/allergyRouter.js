...
router.get('/', asyncErrorHandler(async function (req, res) {
    ...
    const response = await client.getAllergyList(current_user);
...
router.get('/:identifier', asyncErrorHandler(async function (req, res) {
    ...
    const response = await client.getAllergyById(identifier, current_user);
...
router.get('/:identifier/patient/:patient_id', asyncErrorHandler(async function (req, res) {
    ...
    const response = await client.getAllergyByIdAndPatientId(identifier, patient_id, current_user);
